...
create table city(
    id bigint(100)  unsigned unique AUTO_INCREMENT NOT NULL primary key ,
    name varchar(100)  unique not null
)comment '城市';

insert into city values (1,'台北市'),
                        (2,'新北市'),
                        (3,'桃園市'),
                        (4,'台中市'),
                        (5,'台南市'),
...
create table Township(
                     ...
                     city_id bigint(100) unsigned not null,
                     CONSTRAINT fk_city FOREIGN KEY (city_id) REFERENCES city (id)
)comment '區';

insert into Township (name, city_id) values
-- 台北市
('中正區', 1), ('大同區', 1), ('中山區', 1), ('松山區', 1), ('大安區', 1),
('萬華區', 1), ('信義區', 1), ('士林區', 1), ('北投區', 1), ('內湖區', 1),
('南港區', 1), ('文山區', 1),

-- 新北市
('板橋區', 2), ('三重區', 2), ('中和區', 2), ('永和區', 2), ('新莊區', 2),
('新店區', 2), ('樹林區', 2), ('鶯歌區', 2), ('三峽區', 2), ('淡水區', 2),
('汐止區', 2), ('瑞芳區', 2), ('土城區', 2), ('蘆洲區', 2), ('五股區', 2),
('泰山區', 2), ('林口區', 2), ('深坑區', 2), ('石碇區', 2), ('坪林區', 2),
('三芝區', 2), ('石門區', 2), ('八里區', 2), ('平溪區', 2), ('雙溪區', 2),
('貢寮區', 2), ('金山區', 2), ('萬里區', 2), ('烏來區', 2),

-- 桃園市
('桃園區', 3), ('中壢區', 3), ('平鎮區', 3), ('八德區', 3), ('楊梅區', 3),
('蘆竹區', 3), ('大溪區', 3), ('龍潭區', 3), ('龜山區', 3), ('大園區', 3),
('觀音區', 3), ('新屋區', 3), ('復興區', 3),

-- 台中市
('中區', 4), ('東區', 4), ('南區', 4), ('西區', 4), ('北區', 4),
('北屯區', 4), ('西屯區', 4), ('南屯區', 4), ('太平區', 4), ('大里區', 4),
('霧峰區', 4), ('烏日區', 4), ('豐原區', 4), ('后里區', 4), ('石岡區', 4),
('東勢區', 4), ('和平區', 4), ('新社區', 4), ('潭子區', 4), ('大雅區', 4),
('神岡區', 4), ('大肚區', 4), ('沙鹿區', 4), ('龍井區', 4), ('梧棲區', 4),
('清水區', 4), ('大甲區', 4), ('外埔區', 4), ('大安區', 4),

-- 台南市
('中西區', 5), ('東區', 5), ('南區', 5), ('北區', 5), ('安平區', 5),
('安南區', 5), ('永康區', 5), ('歸仁區', 5), ('新化區', 5), ('左鎮區', 5),
('玉井區', 5), ('楠西區', 5), ('南化區', 5), ('仁德區', 5), ('關廟區', 5),
('龍崎區', 5), ('官田區', 5), ('麻豆區', 5), ('佳里區', 5), ('西港區', 5),
('七股區', 5), ('將軍區', 5), ('學甲區', 5), ('北門區', 5), ('新營區', 5),
('後壁區', 5), ('白河區', 5), ('東山區', 5), ('六甲區', 5), ('下營區', 5),
('柳營區', 5), ('鹽水區', 5), ('善化區', 5), ('大內區', 5), ('山上區', 5),
('新市區', 5), ('安定區', 5),

-- 高雄市
('新興區', 6), ('前金區', 6), ('苓雅區', 6), ('鹽埕區', 6), ('鼓山區', 6),
('旗津區', 6), ('前鎮區', 6), ('三民區', 6), ('楠梓區', 6), ('小港區', 6),
('左營區', 6), ('仁武區', 6), ('大社區', 6), ('岡山區', 6), ('路竹區', 6),
('阿蓮區', 6), ('田寮區', 6), ('燕巢區', 6), ('橋頭區', 6), ('梓官區', 6),
('彌陀區', 6), ('永安區', 6), ('湖內區', 6), ('鳳山區', 6), ('大寮區', 6),
('林園區', 6), ('鳥松區', 6), ('大樹區', 6), ('旗山區', 6), ('美濃區', 6),
('六龜區', 6), ('內門區', 6), ('杉林區', 6), ('甲仙區', 6), ('桃源區', 6),
('那瑪夏區', 6), ('茂林區', 6), ('茄萣區', 6),

-- 基隆市
('仁愛區', 7), ('信義區', 7), ('中正區', 7), ('中山區', 7), ('安樂區', 7),
('暖暖區', 7), ('七堵區', 7),
-- 新竹市
('東區', 8), ('北區', 8), ('香山區', 8),
-- 新竹縣
('竹北市', 10), ('竹東鎮', 10), ('新埔鎮', 10), ('關西鎮', 10), ('湖口鄉', 10),
('新豐鄉', 10), ('芎林鄉', 10), ('橫山鄉', 10), ('北埔鄉', 10), ('寶山鄉', 10),
('峨眉鄉', 10), ('尖石鄉', 10), ('五峰鄉', 10),
-- 苗栗縣
('苗栗市', 11), ('頭份市', 11), ('竹南鎮', 11), ('後龍鎮', 11), ('通霄鎮', 11),
('苑裡鎮', 11), ('卓蘭鎮', 11), ('造橋鄉', 11), ('西湖鄉', 11), ('頭屋鄉', 11),
('公館鄉', 11), ('銅鑼鄉', 11), ('三義鄉', 11), ('大湖鄉', 11), ('三灣鄉', 11),
('南庄鄉', 11), ('泰安鄉', 11),
-- 彰化縣
('彰化市', 12), ('鹿港鎮', 12), ('和美鎮', 12), ('員林市', 12), ('溪湖鎮', 12),
('田中鎮', 12), ('北斗鎮', 12), ('二林鎮', 12), ('線西鄉', 12), ('伸港鄉', 12),
('福興鄉', 12), ('秀水鄉', 12), ('花壇鄉', 12), ('芬園鄉', 12), ('大村鄉', 12),
('埔鹽鄉', 12), ('埔心鄉', 12), ('永靖鄉', 12), ('社頭鄉', 12), ('二水鄉', 12),
('田尾鄉', 12), ('埤頭鄉', 12), ('溪州鄉', 12),
-- 南投縣
('南投市', 13), ('埔里鎮', 13), ('草屯鎮', 13), ('竹山鎮', 13), ('集集鎮', 13),
('名間鄉', 13), ('鹿谷鄉', 13), ('中寮鄉', 13), ('魚池鄉', 13), ('國姓鄉', 13),
('水里鄉', 13), ('信義鄉', 13), ('仁愛鄉', 13),
-- 雲林縣
('斗六市', 14), ('斗南鎮', 14), ('虎尾鎮', 14), ('西螺鎮', 14), ('土庫鎮', 14),
('北港鎮', 14), ('林內鄉', 14), ('古坑鄉', 14), ('大埤鄉', 14), ('莿桐鄉', 14),
('褒忠鄉', 14), ('二崙鄉', 14), ('崙背鄉', 14), ('麥寮鄉', 14), ('東勢鄉', 14),
('台西鄉', 14), ('四湖鄉', 14), ('口湖鄉', 14), ('水林鄉', 14),
-- 嘉義市
('東區', 9), ('西區', 9),
-- 嘉義縣
('太保市', 15), ('朴子市', 15), ('布袋鎮', 15), ('大林鎮', 15), ('民雄鄉', 15),
('溪口鄉', 15), ('新港鄉', 15), ('六腳鄉', 15), ('東石鄉', 15), ('義竹鄉', 15),
('鹿草鄉', 15), ('水上鄉', 15), ('中埔鄉', 15), ('竹崎鄉', 15), ('梅山鄉', 15),
('番路鄉', 15), ('大埔鄉', 15), ('阿里山鄉', 15),
-- 屏東縣
('屏東市', 16), ('潮州鎮', 16), ('東港鎮', 16), ('恆春鎮', 16), ('萬丹鄉', 16),
('長治鄉', 16), ('麟洛鄉', 16), ('九如鄉', 16), ('里港鄉', 16), ('鹽埔鄉', 16),
('高樹鄉', 16), ('萬巒鄉', 16), ('內埔鄉', 16), ('竹田鄉', 16), ('新埤鄉', 16),
('枋寮鄉', 16), ('枋山鄉', 16), ('三地門鄉', 16), ('霧台鄉', 16), ('瑪家鄉', 16),
('泰武鄉', 16), ('來義鄉', 16), ('春日鄉', 16), ('獅子鄉', 16), ('牡丹鄉', 16),
('車城鄉', 16), ('滿州鄉', 16),
-- 宜蘭縣
('宜蘭市', 17), ('羅東鎮', 17), ('蘇澳鎮', 17), ('頭城鎮', 17), ('礁溪鄉', 17),
('壯圍鄉', 17), ('員山鄉', 17), ('冬山鄉', 17), ('五結鄉', 17), ('三星鄉', 17),
('大同鄉', 17), ('南澳鄉', 17),
-- 花蓮縣
('花蓮市', 18), ('鳳林鎮', 18), ('玉里鎮', 18), ('新城鄉', 18), ('吉安鄉', 18),
('壽豐鄉', 18), ('光復鄉', 18), ('豐濱鄉', 18), ('瑞穗鄉', 18), ('萬榮鄉', 18),
('卓溪鄉', 18), ('富里鄉', 18),
-- 臺東縣
('臺東市', 19), ('成功鎮', 19), ('關山鎮', 19), ('卑南鄉', 19), ('鹿野鄉', 19),
('池上鄉', 19), ('東河鄉', 19), ('長濱鄉', 19), ('太麻里鄉', 19), ('金峰鄉', 19),
('大武鄉', 19), ('達仁鄉', 19), ('綠島鄉', 19), ('蘭嶼鄉', 19),
-- 澎湖縣
('馬公市', 20), ('湖西鄉', 20), ('白沙鄉', 20), ('西嶼鄉', 20), ('望安鄉', 20),
('七美鄉', 20),
-- 金門縣
('金城鎮', 21), ('金湖鎮', 21), ('金沙鎮', 21), ('金寧鄉', 21), ('烈嶼鄉', 21),
('烏坵鄉', 21),
-- 連江縣
...
CREATE TABLE `orders` (
                          ...
                          `billing_address_id` bigint UNIQUE DEFAULT NULL ,
                          `customer_id` bigint DEFAULT NULL,
                          `shipping_address_id` bigint UNIQUE DEFAULT NULL,
                          `township` varchar(128) DEFAULT NULL,
                          `date_created` datetime(6) DEFAULT NULL,
                          `last_updated` datetime(6) DEFAULT NULL,
